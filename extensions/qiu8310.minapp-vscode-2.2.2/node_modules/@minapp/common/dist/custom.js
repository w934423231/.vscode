        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    resolves = resolves || [];
                    localResolves = filepath.startsWith('.')
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        ...
                                                        case 3:
                                                            ...
                                                            return [4 /*yield*/, lib_1.exists(f1)];
                                                        case 4:
                                                            if (!_a.sent()) return [3 /*break*/, 5];
                                                            found = f1;
                                                            return [3 /*break*/, 7];
                                                        case 5: return [4 /*yield*/, lib_1.exists(f2)];
                                                        case 6:
                                                            if (_a.sent())
                                                                found = f2;
                                                            _a.label = 7;
                ...
                case 2:
                    ...
                    return [4 /*yield*/, lib_1.readFile(found)];
                case 3:
...
function getCachedJsonFile(filename) {
    ...
    if (!JSON_CACHE[cacheKey]) {
        JSON_CACHE[cacheKey] = new lib_1.ConditionalCacheableFile(function () { return getJsonFilePath(dir, base); }, function (name, buf) { return JSON5.parse(buf.toString()); });
    }
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    base += '.';
                    return [4 /*yield*/, lib_1.readdir(dir)];
                case 1:
                    names = _a.sent();
                    name = names.find(function (n) { return n.startsWith(base) && !n.substr(base.length).includes('.') && dev_1.JSON_REGEXP.test(n); });
